...
raxmlHPC-PTHREADS-AVX -T 8 -f a -m GTRGAMMA -p 618 -N 2 -x 309 -s AllBears.aln -n AllBearsTrees -w /project/inbre-train/inbre019/JustinMOLB4485/Koh_Phylo/AllBearsTrees -o Giant Panda
